...
<table class="table gradient">
    ...
    <tr>
        <td></td>
        <td style="width: 80%">
            <p class="nome-aplicacao"> Fake SUS </p>
        </td>
        <td></td>
    </tr>
    </thead>
    ...
    <tr>
        ...
        <td class="body">
            <div class="body-content">
                <p class="text">O seu <strong class="text-decoration">token</strong> para confirmação de email é:</p>
            ...
            <div class="body-foot">
                ...
                <p class="text2 text-decoration">Equipe Fake SUS.</p>
            </div>
        </td>
