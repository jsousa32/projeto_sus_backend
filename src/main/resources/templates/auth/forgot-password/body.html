    ...
    <tr>
        ...
        <td class="body">
            <div class="body-content">
                <p class="text">Para redefinir sua senha, clique no <strong class="text-decoration">botão</strong> abaixo.</p>
                <div class="content-center">
                    <a href="${url}" class="botao">Clique aqui</a>
                </div>
                <p class="text">
                    Lembre-se: por segurança,
                    <span class="text-decoration">não compartilhe</span> este e-mail com outras pessoas!
                </p>
                <div>
